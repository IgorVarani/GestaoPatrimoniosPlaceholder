            ...
            <section className={`${styles.container_cadastro_area} layout_guide`}>
                ...
                <form className={styles.form_cadastro_responsavel}>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        value={cep} onChange={(e) => setCep(e.target.value)} onBlur={buscarCep}/>
                    </div>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        value={logradouro} onChange={(e) => setLogradouro(e.target.value)} onBlur={buscarCep}/>
                    </div>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        value={bairro} onChange={(e) => setBairro(e.target.value)} onBlur={buscarCep}/>
                    </div>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        value={cidade} onChange={(e) => setCidade(e.target.value)} onBlur={buscarCep}/>
                    </div>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        value={estado} onChange={(e) => setEstado(e.target.value)} onBlur={buscarCep}/>
                    </div>
